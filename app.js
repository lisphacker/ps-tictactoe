...
(function(exports) {
  ...
  var showPlayer = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at Game line 19, column 1 - line 19, column 35: " + [ v.constructor.name ]);
  });
  ...
  var enumMoves = function (v) {
      var f = function (i) {
          return function (v1) {
              ...
              throw new Error("Failed pattern match at Game line 91, column 9 - line 92, column 9: " + [ i.constructor.name, v1.constructor.name ]);
          };
      };
  ...
  var evaluate = function (depth) {
      return function (v) {
          ...
          var computeScore = function (move) {
              ...
              throw new Error("Failed pattern match at Game line 99, column 29 - line 103, column 9: " + [ v1.constructor.name ]);
          };
...
(function(exports) {
  ...
  var showStatus = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at Main line 44, column 1 - line 44, column 35: " + [ v.constructor.name ]);
  });
          ...
          var div = (function () {
              ...
              if (v instanceof Data_Maybe.Just && v.value0 instanceof Data_Maybe.Nothing) {
                  return Halogen_HTML_Elements.div((function () {
                      var $17 = Data_Eq.eq(eqStatus)(state.status)(InProgress.value);
                      if ($17) {
                          return [ css, Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Play.create(pos))) ];
                      };
                      return [ css ];
              ...
              throw new Error("Failed pattern match at Main line 74, column 35 - line 83, column 71: " + [ v.constructor.name ]);
          })();
          ...
          var makePlay = function (pos) {
              return function (state) {
                  ...
                  if (v instanceof Data_Maybe.Just) {
                      ...
                      throw new Error("Failed pattern match at Main line 161, column 32 - line 171, column 78: " + [ v2.constructor.name ]);
                  };
                  if (v instanceof Data_Maybe.Nothing) {
                      return {
                  ...
                  throw new Error("Failed pattern match at Main line 149, column 34 - line 172, column 71: " + [ v.constructor.name ]);
              };
          };
          return function (v) {
              ...
              throw new Error("Failed pattern match at Main line 135, column 12 - line 146, column 16: " + [ v.constructor.name ]);
          };
      })();
