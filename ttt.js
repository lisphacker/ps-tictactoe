...
(function($PS) {
  ...
  var valVerticalAlign = new CSS_Property.Val(function (v) {
      ...
      throw new Error("Failed pattern match at CSS.VerticalAlign (line 22, column 1 - line 33, column 37): " + [ v.constructor.name ]);
  });
...
(function($PS) {
  ...
  var showPlayer = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at Game (line 19, column 1 - line 21, column 15): " + [ v.constructor.name ]);
  });
  var showGameState = new Data_Show.Show(function (v) {
      return "<" + (Data_Show.show(Data_Show.showArray(Data_Maybe.showMaybe(showPlayer)))(v.value0.cells) + (" " + (Data_Show.show(showPlayer)(v.value0.player) + ">")));
  });
  var play = function (i) {
      return function (v) {
          if (Data_Maybe.isNothing(Data_Array.index(v.value0.cells)(i))) {
              return Data_Maybe.Nothing.value;
          };
          if (Data_Boolean.otherwise) {
              var setCell = function (v1) {
                  if (v1 instanceof Data_Maybe.Nothing) {
                      return Data_Maybe.Just.create(new Data_Maybe.Just(v.value0.player));
                  };
                  return Data_Maybe.Nothing.value;
              };
              var maybeCells$prime = Data_Array.alterAt(i)(setCell)(v.value0.cells);
              if (maybeCells$prime instanceof Data_Maybe.Just) {
                  return Data_Maybe.Just.create(new GameState({
                      cells: maybeCells$prime.value0,
                      player: v.value0.player
                  }));
              };
              if (maybeCells$prime instanceof Data_Maybe.Nothing) {
                  return Data_Maybe.Nothing.value;
              };
              throw new Error("Failed pattern match at Game (line 47, column 31 - line 49, column 55): " + [ maybeCells$prime.constructor.name ]);
          };
          throw new Error("Failed pattern match at Game (line 42, column 1 - line 42, column 44): " + [ i.constructor.name, v.constructor.name ]);
      };
  };
  var nextPlayer = function (v) {
      ...
      throw new Error("Failed pattern match at Game (line 28, column 1 - line 28, column 31): " + [ v.constructor.name ]);
  };
  var switchPlayer = function (v) {
      return new GameState({
          cells: v.value0.cells,
          player: nextPlayer(v.value0.player)
      });
  };
  var newGame = new GameState({
      cells: Data_Array.replicate(9)(Data_Maybe.Nothing.value),
      player: X.value
  });                                                                                                                    
  ...
  var win = function (v) {
      var allSame$prime = function (v1) {
          return function (v2) {
              return function (v3) {
                  if (v1 instanceof Data_Maybe.Just && (v1.value0 instanceof Data_Maybe.Just && (v2 instanceof Data_Maybe.Just && (v2.value0 instanceof Data_Maybe.Just && (v3 instanceof Data_Maybe.Just && v3.value0 instanceof Data_Maybe.Just))))) {
                      return Data_Eq.eq(eqPlayer)(v1.value0.value0)(v.value0.player) && (Data_Eq.eq(eqPlayer)(v2.value0.value0)(v.value0.player) && Data_Eq.eq(eqPlayer)(v3.value0.value0)(v.value0.player));
                  };
                  return false;
              };
          };
      };
      var allSame = function (i) {
          return function (j) {
              return function (k) {
                  var mck = Data_Array.index(v.value0.cells)(k);
                  var mcj = Data_Array.index(v.value0.cells)(j);
                  var mci = Data_Array.index(v.value0.cells)(i);
                  return allSame$prime(mci)(mcj)(mck);
              };
          };
      };
      return allSame(0)(1)(2) || (allSame(3)(4)(5) || (allSame(6)(7)(8) || (allSame(0)(3)(6) || (allSame(1)(4)(7) || (allSame(2)(5)(8) || (allSame(0)(4)(8) || allSame(2)(4)(6)))))));
  };
  var enumMoves = function (v) {
      var f = function (i) {
          return function (v1) {
              if (v1 instanceof Data_Maybe.Just) {
                  return -1 | 0;
              ...
              throw new Error("Failed pattern match at Game (line 91, column 9 - line 91, column 26): " + [ i.constructor.name, v1.constructor.name ]);
          };
      };
      return Data_Array.filter(function (x) {
          return x !== (-1 | 0);
      })(Data_Array.mapWithIndex(f)(v.value0.cells));
  };
  var drawScore = 0;
  var draw = function (v) {
      var v1 = Data_Array.elemIndex(Data_Maybe.eqMaybe(eqPlayer))(Data_Maybe.Nothing.value)(v.value0.cells);
      if (v1 instanceof Data_Maybe.Just) {
          return false;
      };
      if (v1 instanceof Data_Maybe.Nothing) {
      ...
      throw new Error("Failed pattern match at Game (line 85, column 41 - line 87, column 66): " + [ v1.constructor.name ]);
  };
  var evaluate = function (depth) {
      return function (v) {
          var maybeComputeScore = function (move) {
              return Control_Bind.bind(Data_Maybe.bindMaybe)(play(move)(v))(function (v1) {
                  var score = (function () {
                      var $71 = win(v1);
                      if ($71) {
                          return winScore;
                      ...
                      var v2 = evaluate(depth + 1 | 0)(switchPlayer(v1));
                      return -Data_EuclideanRing.div(Data_EuclideanRing.euclideanRingInt)(v2.value1)(2) | 0;
                  })();
                  return Control_Applicative.pure(Data_Maybe.applicativeMaybe)(score);
              });
          };
          var maxScoredMove = function (moves) {
              return function (scores) {
                  var f = function (v1) {
                      return function (v2) {
                          var $78 = v2.value1 > v1.value1;
                          if ($78) {
                              return v2;
                          };
                          return v1;
                  ...
                  return Data_Foldable.foldl(Data_Foldable.foldableArray)(f)(new Data_Tuple.Tuple(-1 | 0, (-winScore | 0) - 1 | 0))(Data_Array.zip(moves)(scores));
              };
          };
          var computeScore = function (move) {
              var v1 = maybeComputeScore(move);
              if (v1 instanceof Data_Maybe.Just) {
                  return v1.value0;
              };
              if (v1 instanceof Data_Maybe.Nothing) {
              ...
              throw new Error("Failed pattern match at Game (line 99, column 29 - line 101, column 46): " + [ v1.constructor.name ]);
          };
          var moves = enumMoves(v);
          var scores = Data_Functor.map(Data_Functor.functorArray)(computeScore)(moves);
          return maxScoredMove(moves)(scores);
      };
  };
  exports["X"] = X;
  exports["O"] = O;
  ...
  exports["winScore"] = winScore;
  exports["drawScore"] = drawScore;
  exports["win"] = win;
  exports["draw"] = draw;
  exports["enumMoves"] = enumMoves;
...
(function($PS) {
  ...
  var ResetGame = (function () {
      function ResetGame(value0) {
          this.value0 = value0;
      };
      ResetGame.create = function (value0) {
          return new ResetGame(value0);
      };
      return ResetGame;
  })();
  var Play = (function () {
  ...
  var showStatus = new Data_Show.Show(function (v) {
      ...
      if (v instanceof YouWin) {
          return "You win !!!";
      };
      if (v instanceof IWin) {
          return "I win !!!";
      };
      ...
      throw new Error("Failed pattern match at Main (line 38, column 1 - line 43, column 36): " + [ v.constructor.name ]);
  });
  var eqStatus = new Data_Eq.Eq(function (x) {
      return function (y) {
          ...
          if (x instanceof YouWin && y instanceof YouWin) {
              return true;
          };
          if (x instanceof IWin && y instanceof IWin) {
              return true;
          };
  ...
  var cellSize = Data_Int.toNumber(100);
  var genCellView = function (pos) {
      return function (state) {
          var css = Halogen_HTML_CSS.style(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.width(CSS_Size.px(cellSize)))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.height(CSS_Size.px(cellSize)))(function () {
                  return CSS_Font.fontSize(CSS_Size.pt(Data_Int.toNumber(40)));
              });
          }));
          var div = (function () {
              var v = Data_Array.index(state.gameState.value0.cells)(pos);
              if (v instanceof Data_Maybe.Just && v.value0 instanceof Data_Maybe.Just) {
                  return Halogen_HTML_Elements.div([ css ])([ Halogen_HTML_Core.text(Data_Show.show(Game.showPlayer)(v.value0.value0)) ]);
              };
              if (v instanceof Data_Maybe.Just && v.value0 instanceof Data_Maybe.Nothing) {
                  return Halogen_HTML_Elements.div((function () {
                      var $20 = Data_Eq.eq(eqStatus)(state.status)(InProgress.value);
                      if ($20) {
                          return [ css, Halogen_HTML_Events.onClick(function (v1) {
                              return new Data_Maybe.Just(new Play(pos, Data_Unit.unit));
                          }) ];
                      };
                      return [ css ];
              ...
              if (v instanceof Data_Maybe.Nothing) {
                  return Halogen_HTML_Elements.div([  ])([ Halogen_HTML_Core.text(" ") ]);
              };
              throw new Error("Failed pattern match at Main (line 69, column 35 - line 78, column 71): " + [ v.constructor.name ]);
          })();
          return Halogen_HTML_Elements.td([ Halogen_HTML_CSS.style(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Border.border(CSS_Border.solid)(CSS_Size.px(Data_Int.toNumber(1)))(Color.black))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_TextAlign.textAlign(CSS_TextAlign.center))(function () {
                  return CSS_VerticalAlign.verticalAlign(CSS_VerticalAlign.Middle.value);
              });
          })) ])([ div ]);
      };
  };
  var myBoard = (function () {
      var render = function (state) {
          var label = Data_Show.show(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
              return "gameState";
          }))(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
              return "status";
          }))(Data_Show.showRecordFieldsNil)(showStatus))(Game.showGameState)))(state);
          return Halogen_HTML_Elements.div([  ])([ Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v) {
              return new Data_Maybe.Just(new ResetGame(Data_Unit.unit));
          }) ])([ Halogen_HTML_Core.text("Reset") ]), Halogen_HTML_Elements.table([  ])([ Halogen_HTML_Elements.tr([  ])([ genCellView(0)(state), genCellView(1)(state), genCellView(2)(state) ]), Halogen_HTML_Elements.tr([  ])([ genCellView(3)(state), genCellView(4)(state), genCellView(5)(state) ]), Halogen_HTML_Elements.tr([  ])([ genCellView(6)(state), genCellView(7)(state), genCellView(8)(state) ]) ]), Halogen_HTML_Core.text(Data_Show.show(showStatus)(state.status)) ]);
      };
      var initialState = {
      ...
      var handleAction = (function () {
          var makePlay = function (pos) {
              return function (state) {
                  var v = Game.play(pos)(state.gameState);
                  if (v instanceof Data_Maybe.Just) {
                      var $26 = Game.win(v.value0);
                      if ($26) {
                          return {
                              gameState: v.value0,
                              status: YouWin.value
                      ...
                      var gs3 = Game.switchPlayer(v.value0);
                      var v1 = Game.evaluate(0)(gs3);
                      var v2 = Game.play(v1.value0)(gs3);
                      if (v2 instanceof Data_Maybe.Just) {
                          var $30 = Game.win(v2.value0);
                          if ($30) {
                              return {
                                  gameState: v2.value0,
                                  status: IWin.value
                          ...
                          return {
                              gameState: Game.switchPlayer(v2.value0),
                              status: InProgress.value
                          };
                      };
                      if (v2 instanceof Data_Maybe.Nothing) {
                      ...
                      throw new Error("Failed pattern match at Main (line 162, column 32 - line 172, column 78): " + [ v2.constructor.name ]);
                  };
                  if (v instanceof Data_Maybe.Nothing) {
                      return {
                  ...
                  throw new Error("Failed pattern match at Main (line 150, column 34 - line 173, column 71): " + [ v.constructor.name ]);
              };
          };
          return function (v) {
              if (v instanceof ResetGame) {
              ...
              if (v instanceof Play) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(makePlay(v.value0)))(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                  });
              };
              throw new Error("Failed pattern match at Main (line 136, column 20 - line 147, column 16): " + [ v.constructor.name ]);
          };
      })();
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Halogen_VDom_Driver.runUI(myBoard)(Data_Unit.unit)(v);
  }));
  ...
  exports["genCellView"] = genCellView;
  exports["myBoard"] = myBoard;
  exports["main"] = main;
